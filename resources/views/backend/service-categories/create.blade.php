...
<div class="sc-page">
    <div class="sc-header">
        <div class="sc-header-inner">
            <div>
                <h4 class="sc-header-title">Add New Category</h4>
                <p class="sc-header-sub">Create a service category to organize your services</p>
            </div>
    ...
    @include('backend.service-categories.form', [
        'action'      => route('service-categories.store'),
        'method'      => null,
