...
class SiteServiceSeeder extends Seeder
{
    public function run(): void
    {
        $services = [
            ...
            ['name' => 'Book Translation',               'category' => 'production', 'url' => '/services/book-translation',   'price' => 'From £797',   'delivery_time' => '2–4 weeks',     'badge' => null,        'has_arrow' => true, 'is_dark' => false],
