...
<div class="topbar">
    <div class="topbar-inner">
        ...
        <span>Trusted by 10,000+ authors</span>
        ...
        <nav class="nav">
            ...
            <div class="services">
                ...
                <div class="dropdown">
                    ...
                    <a href="/services/childrens-book-formatting">Children's Formatting</a>
            ...
            <a href="{{ route('services.consultation') }}" class="start-btn">
                Start Your Project
            </a>
