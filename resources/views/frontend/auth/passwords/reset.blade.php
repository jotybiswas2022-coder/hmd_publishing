...
<head>
    ...
    <title>Reset Password | HMD Publishing</title>
    ...
    <div class="au-container" style="max-width:500px;">
        <div class="au-card" style="text-align:center;">
            ...
            <div class="au-card-header">
                ...
                <p class="au-card-subtitle">Enter your new password below</p>
            </div>
            ...
            <div class="au-card-body">
                <form method="POST" action="{{ route('password.update') }}">
                    ...
                    <div class="au-input-group">
                        <label class="au-input-label" for="password">New Password</label>
                        <div class="au-input-wrap">
