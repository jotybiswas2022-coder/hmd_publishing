...
<div class="pf-page">
    <div class="pf-header">
        <div class="pf-header-inner">
            <div>
                <h4 class="pf-header-title">Add New Portfolio Item</h4>
                <p class="pf-header-sub">Add a book cover or project to the public portfolio page</p>
            </div>
    ...
    @include('backend.portfolio.form', [
        'action'      => route('portfolio.items.store'),
        'method'      => null,
