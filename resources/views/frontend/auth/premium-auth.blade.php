    ...
    <style>
        ...
        *, *::before, *::after { margin:0; padding:0; box-sizing:border-box; }
        ...
        .pa-orb {
            ...
            filter: blur(100px);
            opacity: 0.5;
            animation: pa-orb-float 20s ease-in-out infinite alternate;
        }
        .pa-orb-1 {
        ...
        .pa-particle {
            ...
            border-radius: 50%;
            animation: pa-particle-rise linear infinite;
        }
        @keyframes pa-particle-rise {
        ...
        .pa-badge-dot {
            ...
            animation: pa-badge-pulse 2s ease-in-out infinite;
        }
        ...
        .pa-error-text { display: block; color: #f87171; font-size: 12px; margin-top: 6px; font-weight: 500; }
        ...
        .pa-checkbox-label { font-size: 13px; color: rgba(255,255,255,0.45); font-weight: 500; }
        ...
        .pa-forgot-link:hover { color: #c4b5fd; }
        ...
        .pa-terms .pa-checkbox-label { font-size: 12px; }
        .pa-terms a { color: #a78bfa; text-decoration: none; font-weight: 600; }

        /* ===================== RESPONSIVE ===================== */
        @media (max-width: 480px) {
            .pa-card { padding: 28px 20px; border-radius: 20px; }
            .pa-social-row { flex-direction: column; }
            .pa-options-row { flex-direction: column; gap: 12px; align-items: flex-start; }
            .pa-card-title { font-size: 22px; }
        }
    </style>
</head>
<body>
...
<div class="pa-wrapper">
    ...
    <!-- Logo -->
    <div class="pa-logo">
        <a href="/">HMD <span>Publishing</span></a>
    </div>
    ...
    <!-- ===== LOGIN CARD ===== -->
    <div class="pa-card" id="loginCard">
        <div class="pa-card-header">
            <div class="pa-card-icon">
                <i class="bi bi-person-circle"></i>
            </div>
            <h2 class="pa-card-title">Welcome back</h2>
            <p class="pa-card-subtitle">Sign in to your author dashboard</p>
        </div>
        ...
        <form method="POST" action="{{ route('login') }}" id="loginForm" autocomplete="off">
            ...
            <div class="pa-input-group">
                ...
                <div class="pa-input-wrap">
                    ...
                    <input id="email" type="email"
                           class="pa-input @error('email') pa-input-error @enderror"
                           name="email"
                           value="{{ old('email') }}"
                ...
                @error('email')
                    <span class="pa-error-text">{{ $message }}</span>
                @enderror
            </div>
            ...
            <div class="pa-input-group">
                ...
                <div class="pa-input-wrap">
                    ...
                    <input id="password" type="password"
                           class="pa-input @error('password') pa-input-error @enderror"
                           name="password"
                           placeholder="••••••••"
                           required autocomplete="current-password">
                    <button type="button" class="pa-pw-toggle" id="pwToggle" tabindex="-1">
            ...
            <!-- Options -->
            <div class="pa-options-row">
                <label class="pa-checkbox">
                    <input type="checkbox" name="remember" id="remember" {{ old('remember') ? 'checked' : '' }}>
                    <span class="pa-checkbox-mark"><i class="bi bi-check"></i></span>
                    <span class="pa-checkbox-label">Remember me</span>
                </label>
                @if (Route::has('password.request'))
                    <a href="{{ route('password.request') }}" class="pa-forgot-link">Forgot password?</a>
                @endif
            </div>

            <!-- Submit -->
            <button type="submit" class="pa-submit-btn" id="loginSubmitBtn">
                <span class="pa-btn-text">Sign In</span>
            </button>
        </form>

        <!-- Divider -->
        <div class="pa-divider"><span>Or continue with</span></div>

        <!-- Social -->
        <div class="pa-social-row">
            <button type="button" class="pa-social-btn" onclick="Swal.fire({icon:'info',title:'Coming Soon',text:'Google login coming soon!',background:'rgba(15,15,30,1)',color:'#fff',confirmButtonColor:'#6366f1'})">
                <svg viewBox="0 0 24 24"><path fill="#4285F4" d="M22.56 12.25c0-.78-.07-1.53-.2-2.25H12v4.26h5.92a5.06 5.06 0 0 1-2.2 3.32v2.77h3.57c2.08-1.92 3.28-4.74 3.28-8.1z"/><path fill="#34A853" d="M12 23c2.97 0 5.46-.98 7.28-2.66l-3.57-2.77c-.98.66-2.23 1.06-3.71 1.06-2.86 0-5.29-1.93-6.16-4.53H2.18v2.84C3.99 20.53 7.7 23 12 23z"/><path fill="#FBBC05" d="M5.84 14.09c-.22-.66-.35-1.36-.35-2.09s.13-1.43.35-2.09V7.07H2.18C1.43 8.55 1 10.22 1 12s.43 3.45 1.18 4.93l2.85-2.22.81-.62z"/><path fill="#EA4335" d="M12 5.38c1.62 0 3.06.56 4.21 1.64l3.15-3.15C17.45 2.09 14.97 1 12 1 7.7 1 3.99 3.47 2.18 7.07l3.66 2.84c.87-2.6 3.3-4.53 6.16-4.53z"/></svg>
                Google
            </button>
            <button type="button" class="pa-social-btn" onclick="Swal.fire({icon:'info',title:'Coming Soon',text:'GitHub login coming soon!',background:'rgba(15,15,30,1)',color:'#fff',confirmButtonColor:'#6366f1'})">
        ...
        <div class="pa-switch">
            ...
            <a href="{{ route('register') }}" class="pa-switch-link">Create account <i class="bi bi-arrow-right"></i></a>
        </div>
    ...
    <div style="text-align:center;margin-top:24px;">
        <a href="/" style="color:rgba(255,255,255,0.3);font-size:13px;text-decoration:none;transition:color 0.2s;" onmouseover="this.style.color='rgba(255,255,255,0.6)'" onmouseout="this.style.color='rgba(255,255,255,0.3)'">
            ← Back to HMD Publishing
        </a>
    </div>
</div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (form && btn) {
        form.addEventListener('submit', function() {
            btn.disabled = true;
            const textEl = btn.querySelector('.pa-btn-text');
            textEl.textContent = 'Signing in...';
            const spinner = document.createElement('div');
            spinner.className = 'pa-spinner';
    ...
    if (errEl) {
        try {
            const errs = JSON.parse(errEl.value);
            Swal.fire({
                icon: 'error',
