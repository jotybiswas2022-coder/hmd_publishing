...
<body>
    ...
    <section class="hmd-hero">
        <canvas id="velaris-canvas" class="velaris-canvas"></canvas>
    ...
    <style>
        ...
        .hmd-hero .hmd-hero-title {
            color: #fff;
        }

        .hmd-hero .hmd-hero-desc {
            color: rgba(255,255,255,0.7);
        }

        .hmd-hero .hmd-hero-btns .hmd-btn-dark {
            background: #fff;
            color: #111;
        }

        .hmd-hero .hmd-hero-btns .hmd-btn-outline {
    ...
    <script>
        (function() {
            var canvas = document.getElementById('velaris-canvas');
            if (!canvas) return;
            ...
            var colors = ['#86efac', '#4ade80', '#059669', '#000000'];
            var bg = '#000000';
            var speed = 2.0;
            var grain = 0.3;
